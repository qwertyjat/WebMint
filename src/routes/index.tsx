...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "WebMint — Premium Web Development Studio" },
      { name: "description", content: "Websites that feel as good as they perform. WebMint designs and engineers premium websites, web apps and e-commerce experiences." },
      { property: "og:title", content: "WebMint — Premium Web Development Studio" },
      { property: "og:description", content: "Websites that feel as good as they perform." },
...
function Index() {
  useEffect(() => {
    window.location.replace("/webmint/index.html");
  }, []);
  return (
    <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#0b0f19", color: "#f5f7fb", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ textAlign: "center" }}>
        <div style={{ width: 60, height: 60, borderRadius: 16, background: "linear-gradient(135deg,#10b981,#0ea5e9,#8b5cf6)", display: "grid", placeItems: "center", margin: "0 auto 20px", fontSize: "1.6rem" }}>◆</div>
        <p>Loading WebMint…</p>
        <p style={{ fontSize: 14, opacity: 0.6 }}>
          If you're not redirected, <a href="/webmint/index.html" style={{ color: "#10b981" }}>click here</a>.
        </p>
      </div>
    </div>
  );
